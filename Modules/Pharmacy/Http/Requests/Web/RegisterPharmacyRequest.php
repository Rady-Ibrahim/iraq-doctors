...
class RegisterPharmacyRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        ...
        return [
            ...
            'address.required' => 'عنوان الصيدلية مطلوب',
            'latitude.required' => 'موقع الصيدلية (خط العرض) مطلوب',
            'longitude.required' => 'موقع الصيدلية (خط الطول) مطلوب',
            'logo.required' => 'شعار الصيدلية مطلوب',
            'logo.image' => 'شعار الصيدلية يجب أن يكون صورة',
            'logo.max' => "حجم الشعار يجب أن يكون أقل من {$maxMb} ميجا",
            'commercial_register_document.required' => 'السجل التجاري مطلوب',
            'license_document.required' => 'ترخيص الصيدلية مطلوب',
