        ...
        @else
            ...
            <div id="otp-section" class="hidden space-y-4">
                ...
                <button type="button" id="btn-verify-otp"
                    class="w-full bg-gradient-to-r from-emerald-600 to-green-600 text-white py-3 rounded-lg font-semibold hover:from-emerald-700 hover:to-green-700 transition disabled:opacity-50">
                    تأكيد التفعيل
                </button>
            </div>

            <form id="verify-form" method="POST" action="{{ route('pharmacy.verify-phone.submit') }}" class="hidden">
                @csrf
