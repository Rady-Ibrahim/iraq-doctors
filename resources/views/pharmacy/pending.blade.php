...
<head>
    ...
    <title>حساب قيد المراجعة - الصيدلية</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-6">
    <div class="bg-white rounded-2xl shadow-lg max-w-lg w-full p-8 text-center">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mb-3">حساب الصيدلية قيد المراجعة</h1>
        ...
        <div class="bg-gray-50 rounded-lg p-4 text-right mb-6">
            <p class="text-sm text-gray-600">الصيدلية: <span class="font-semibold text-gray-800">{{ $pharmacy->name }}</span></p>
