    ...
    <div class="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
        ...
        <form id="ghostForm" onsubmit="createGhostPatient(event)" class="space-y-4">
            ...
            <div>
                ...
                <input type="number" id="ghostAge" min="0" max="120" class="w-full px-4 py-2 border rounded-lg" placeholder="مثال: 35">
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition">
            <div class="flex items-center gap-4 mb-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-500">${patient.phone || '-'}${patient.age != null ? ' — ' + patient.age + ' سنة' : ''}</p>
                </div>
            </div>
    ...
    try {
        ...
        const data = await apiCall('/doctor/api/ghost-patients', {
            ...
            body: JSON.stringify({
                ...
                age: document.getElementById('ghostAge').value ? parseInt(document.getElementById('ghostAge').value) : null,
            }),
        });
        if (data?.success) {
