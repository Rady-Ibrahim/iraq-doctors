...
@section('title', 'إعدادات المعمل')
@section('page-title', 'إعدادات المعمل')
@section('page-description', 'الملف الشخصي، ساعات العمل، وسحب العينات من المنزل')

@section('content')
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    <div class="bg-white rounded-xl shadow-sm p-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-6">معلومات المعمل</h3>
        <form id="profileForm" onsubmit="saveProfile(event)" class="space-y-4" enctype="multipart/form-data">
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">اسم المعمل</label>
